    ...
    public static class PracticeSeeder
    {
        public static async Task SeedAsync(PracticeContext context)
        {
            ...
            var skillEndMessages = new (int LegacySkillId, string Text)[]
            {
                ...
                (-2, "ttpogled pomaže da ne žrtvujemo dugoročne odnose zbog trenutne emocije."),
                ...
                (-2, "ttzarobljeni uti izgubimo kontrolu nad svojim mislima.tttstvarima."),
                (-2, "ttodluke koje će nas koštati. Tako možemo uskratiti sebi buduće prilike ili se zameriti ljudima do kojih nam je stalo. Vremenska distanca stavlja stvari u perspektivu i pomaže nam da izbegnemo ove scenarije."),
                ...
                (-3, "tkakve su stvarno mogućnosti pred nama. Bez toga igramo lošije nego što bismo mogli."),
