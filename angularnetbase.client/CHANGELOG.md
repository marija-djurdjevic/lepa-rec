...
- Create Angular project with ng: `ng new angularnetbase.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angularnetbase.client.esproj`).
